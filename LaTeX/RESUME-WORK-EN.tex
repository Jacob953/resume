    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Design \& Implement}
          {Developed a secondary tool for the Behavior3 low-code platform's rule engine, generating .b3 files to simplify node customization, prevent service startup panics, and manage personalized nodes.}
        \resumeItem{Influence}
          {An article titled "Behavior3Gen: A User-Friendly and Secure Behavior3 Framework Development Tool" was published on the internal KM platform, gaining recognition and being featured on the homepage.}
      \resumeItemListEnd
